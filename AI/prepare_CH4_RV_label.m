function labels = prepare_CH4_RV_label(data_dir, label_dir, lax_label, plot_flag, max_N)
% labels = prepare_CH4_RV_label(data_dir, label_dir, lax_label, plot_flag, max_N)
...
for k=1:max_N
    ...
    pt1 = [v.regions(end-2).shape_attributes.cx v.regions(end-2).shape_attributes.cy];
    pt2 = [v.regions(end-1).shape_attributes.cx v.regions(end-1).shape_attributes.cy];
    pt3 = [v.regions(end).shape_attributes.cx v.regions(end).shape_attributes.cy];
    ...
    if(plot_flag)
        ...
        plot(pt2(1)+1, pt2(2)+1, 'bo', 'MarkerSize', 12);
        plot(pt3(1)+1, pt3(2)+1, 'yo', 'MarkerSize', 12);
