function prepare_ai_denoising_training_cine_one_case(h5_name, case_dir, debug_dir, dst_dir, im_series_num, gfactor_series_num)
% prepare_ai_denoising_training_cine_one_case(h5_file, case_dir, debug_dir, dst_dir, im_series_num, gfactor_series_num)

mkdir(dst_dir)

pic_dir = fullfile(dst_dir, 'jpg_pics');
mkdir(pic_dir)
