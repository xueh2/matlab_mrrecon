...
class BallTreeDensity : public BallTree {
 public:
  ...
  //BallTreeDensity( unsigned long d, unsigned long N, double* points_,
...
//  void evaluate(unsigned long Npts, const double* atPoints, double* values, double maxErr=0) const;
...
//  void llGrad(unsigned long Npts, const double* atPoints, double* gradDens, double* gradAt, double tolEval, double tolGrad) const;
