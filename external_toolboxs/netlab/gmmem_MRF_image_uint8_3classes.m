...
function [mix, options, errlog] = gmmem_MRF_image_uint8_3classes(mix, x, options)
...
%     mix.centres
%     mix.covars
    mix = Prior2Classification_uint8_3classes_quick(mix);
    ...
    mix = Classification2Prior_uint8_3classes_quick(mix);
