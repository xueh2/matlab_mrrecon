...
function [mix, options, errlog] = gmmem_MRF_image_uint8_2classes(mix, x, options)
...
%     mix.centres
%     mix.covars
    mix = Prior2Classification_uint8_2classes_quick(mix);
    ...
    mix = Classification2Prior_uint8_2classes_quick(mix);
