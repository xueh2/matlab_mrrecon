function [] = ems_getMRFprior_double(varargin)
% 
% FORMAT MRFprior = ems_getMRFprior_double(classification, playing, atlas, ...
%                   lkp, G, H)
% 
...
%   October 1999
% 
% - classification: a 4-D double matrix of size [I J K N], describing
...
% - atlas: a 4-D double matrix of size [I J K M] describing the
