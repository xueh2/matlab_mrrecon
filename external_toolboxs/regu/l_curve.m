function [reg_corner,rho,eta,reg_param] = l_curve(U,sm,b,method,L,V, plotFlag, smallest_rho)
...
if (nargin<8) smallest_rho = 0; end
...
if (locate)
    if (smallest_rho)
        [reg_corner,rho_c,eta_c] = l_corner_smallest_rho(rho,eta,reg_param,U,sm,b,method); 
    else
