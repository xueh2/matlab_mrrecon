...
%% Problem
%
%  min  1/2 \|Ax -y\|_F^2 + lambda * sum_i ( \| real( x(:,i) )\|_{1} 
%                                          + \| imag( x(:,i) )\|_{1} )
%               + rho* sum_j sum_i ( \| real( x(j,i),x(j,i+1) )\|_{infty}
%                                  + \| imag( x(j,i),x(j,i+1) )\|_{infty} ) 
%
%  x=[x_1, x_2, ..., x_t]
...
for iterStep=1:opts.maxIter
    ...
    while (1)
        ...
        [x_real, infor]=conpagros_matrix(v_real,  lambda/L, rho/L, n, t, 100); 
        [x_imag, infor]=conpagros_matrix(v_imag,  lambda/L, rho/L, n, t, 100); 
