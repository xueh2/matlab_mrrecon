function [x, funVal,  ValueL, mse]=fista_slep_2D_csm_wavelet_weight(A, AT, y, lambda, opts)
%
%%
...
if(isfield(opts,'d'))
    ...
    d=ones(sizeImage(1),sizeImage(2),sizeImage(4))*2;
    d(:,:,2)=5;
end
% weight d
...
q=p;
proximity_operator = @(x, th) Dykstra(x,th,d);
