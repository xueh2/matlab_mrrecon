function [x, funVal,  ValueL, mse]=fista_slep_4D_csm_conpagros(A, AT, y, lambda, opts)
%
%%
...
%                         + rho* sum_j sum_i \|x(j,i),x(j,i+1)\|_{infty}
%
%  x=[x_1, x_2, ..., x_t]
...
%         x_imag = proximity_operator(v_imag, lambda/L);
        ...
        [abs_x, infor]=conpagros_matrix(abs_v,  lambda/L, rho/L, n, t, 100); 
        
        x=v;
        non_z_v=find(abs_v);
        x(non_z_v)=abs_x(non_z_v)./abs_v(non_z_v).*v(non_z_v);
