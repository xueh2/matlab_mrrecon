function [C, rho, S] = CoilSensitivity_Souheil_Walsh_SVDMethod(data, kSize)
...
for x = 1:Nx
    for y = 1:Ny
        ...
        s1 = SP(1,1);
        s_eig = SP(1:Nc,1:Nc); % first singular value
