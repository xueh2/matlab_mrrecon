...
function timeUsed = BuildGadgetronDockerPackageOnRemote(host, res_dir, docker_image, target_dir, create_installers, remove_gtprep_xml)
...
% timeUsed = BuildGadgetronDockerPackageOnRemote('denmark', '/home/GADGETRON_CUDA80', 'xueh2/gadgetron_ubuntu1604_cuda_gtprep', '\\hl-share\RawMRI\Lab-Kellman\Share\Installers\20171117', 1)
% timeUsed = BuildGadgetronDockerPackageOnRemote('denmark', '/home/GADGETRON_CUDA80', 'xueh2/gadgetron_ubuntu1604_cuda_gtprep', '\\hl-share\RawMRI\Lab-Kellman\Share\Installers\20170928_remove_gtprep_xml', 1, 1)

if nargin < 1
    host = 'denmark'
    res_dir = '/home/GADGETRON_CUDA80'
    docker_image = 'xueh2/gadgetron_ubuntu1404_cuda_gtprep'
%     docker_image = 'hansenms/gadgetron_ubuntu1604_cuda_gtprep75'
    target_dir = '/e/temp'
    create_installers = 0
end
...
command = ['scp -i ' getenv('GADGETRON_KEY_FOLDER') '/xueh2_private ' user '@' host ':' res_dir '/' filename '.img.zip ' target_dir];
command
tic; dos(command, '-echo'); toc

command = ['scp -i ' getenv('GADGETRON_KEY_FOLDER') '/xueh2_private ' user '@' host ':' res_dir '/' filename '.img ' target_dir];
command
tic; dos(command, '-echo'); toc
