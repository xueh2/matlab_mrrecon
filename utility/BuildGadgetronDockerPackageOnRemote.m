...
% timeUsed = BuildGadgetronDockerPackageOnRemote('denmark', '/home/GADGETRON_CUDA55', 'xueh2/gadgetron_ubuntu1404_cuda_gtprep ', '\\137.187.134.135\share\Installer\20160720', 1)
...
disp('build package')
gt_command = ['cd ' res_dir ' && sudo ./create_chroot_from_image.sh ' docker_image ' 5120'];
command = ['ssh -i ' key ' ' user '@' host ' "' gt_command '"'];
command
dos(command, '-echo');
