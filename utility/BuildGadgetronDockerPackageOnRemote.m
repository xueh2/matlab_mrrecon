...
% timeUsed = BuildGadgetronDockerPackageOnRemote('denmark', '/home/GADGETRON_CUDA75', 'xueh2/gadgetron_ubuntu1604_cuda_gtprep', '\\hl-share\RawMRI\Lab-Kellman\Share\Installers\20171009', 1)
% timeUsed = BuildGadgetronDockerPackageOnRemote('denmark', '/home/GADGETRON_CUDA75', 'xueh2/gadgetron_ubuntu1604_cuda_gtprep', '\\hl-share\RawMRI\Lab-Kellman\Share\Installers\20170928_remove_gtprep_xml', 1, 1)

if nargin < 1
    host = 'denmark'
    res_dir = '/home/GADGETRON_CUDA75'
...
command = ['scp -i ' getenv('GADGETRON_KEY_FOLDER') '/gtuser_denmark_private ' user '@' host ':' res_dir '/' filename '.img.zip ' target_dir];
command
