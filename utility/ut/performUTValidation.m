...
for ii=startCase:endCase
    ...
    t = run_gt_recon_case(UTCases{ii, 2}, UTCases{ii, 4}, UTCases, deleteh5); % winopen(folderDir)
    ...
    timeUsed{ii, 1} = t;
    timeUsed{ii, 2} = UTCases{ii, 2};
    timeUsed{ii, 3} = folderDir;
