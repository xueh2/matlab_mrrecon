function [headers,protocol]=read_dat_headers(datfilename);
% function [headers,protocol]=read_dat_headers(datfilename);
%
% function to read Siemens dat file headers for meas.dat
%
% headers is output structure containing ascii protocol data in raw text form
%     headers.Config
%     headers.Dicom
%     headers.MeasYaps
%     headers.Phoenix
