function [out]=roi_timeseries(I, roimatfilename, roi_no, image_no);
...
BW=roipoly(I(:,:,1),ROI_info_table(roi_no, image_no).ROI_x_coordinates,ROI_info_table(roi_no, image_no).ROI_y_coordinates);
