...
function [unwrappedIm, fullkspace, sensitivityMap] = TGRAPPA_SPIRiT_FastKernel_2DPlusT_GPU(underSampledKspace, reductionFactor, option)
...
if ( option.multiTaskRecon )   
    ...
    numOfFrameMax = floor(0.35*maxMem/memUsage); % maximal usage of GPU is 1Gbytes
    overlapWidth = 3;
