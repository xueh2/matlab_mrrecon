...
ICI_Array(index(:)) = gaussCurvature(index(:))/(4*pi);

% ECI
ECI_Array = 4*meanCurvature.*sqrt(abs(meanCurvature.*meanCurvature-gaussCurvature));

% GLN
GLN_Array = abs(gaussCurvature);

% MLN
MLN_Array = abs(meanCurvature);
