...
function [LabeledSeg, mix] = LabelPVs_Seg_gmm_4classes_atlas_Global_MEX(mix, segResult, ...
...
[LabeledSeg, Priors, Atlas] = LabelPVs_Seg_gmm_atlas_Global_MEX(single(mix.priors), mix.indexes, segResult, neighborNum, lamda,...
    xsize, ysize, zsize, csflabel, wmlabel, cortexlabel, pvlabel, nonbrainlabel, mix.atlas);
