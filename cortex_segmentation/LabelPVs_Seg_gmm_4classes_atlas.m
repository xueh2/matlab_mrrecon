...
function [LabeledSeg, mix] = LabelPVs_Seg_gmm_4classes_atlas(mix, segResult, ...
...
for pp = 1:ndata
    ...
    [neighbourhood, neighbors] = GetNeighbourhood2_Local(segResult, mix.header, i, j, k, ...
        neighborwidth, partsmask, globalSeg);
...
%             priors(5) = nonbrainNew;
            ...
            mix.atlas(j, i, k, 1) = uint8(round(255*priors(3))); % wm
