...
%     clear csfT cortexT wmT outlierT
    load Before_Seg_forTesting
    mix.lamda = lamda(tt)

    dirName = ['Result_Lemda_' num2str(mix.lamda)];
    mkdir('.',dirName);
    Global_SegResult = ['./' dirName '/'];
    Local_SegResult = ['./' dirName '/'];
    ...
    filename = [Global_SegResult 'segResult_4classes.hdr'];
    ...
    filename = [Global_SegResult 'segResult_4classes_PVs.hdr'];
