...
Global_PVs_dsc_5classes = computeDSC(Global_PVs_dsc_result, classlabel, ...
...
savedfilename = fullfile(AssessDir, 'Global_PVs_dsc_5classes.mat');
save(savedfilename, 'Global_PVs_dsc_5classes', 'tissueVolume');
else
