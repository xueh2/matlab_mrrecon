...
if ( isempty(Kmeans_InitialCentres) == 0 )
    ...
    M(:,1, 1) = [Kmeans_InitialCentres(2); Kmeans_InitialCentres(3)]; 
...
local_SegResults = LocalSegmentation_Kmeans_EM_2classes(imagedata, header, ...
    brainmask, global_SegResult, SplittedBrain, partsNumber, tissuelabels_seg, replicate, M, saveflag, trynumber, LabelPVs_Image);
