...
saveflag = 1;
Kmeans_InitialCentres_3classes = Kmeans_InitialCentres(2:4);
% ======================================== %
...
if ( isempty(Kmeans_InitialCentres) == 0 )
    ...
    M(:,1, 1) = Kmeans_InitialCentres_3classes; 
...
% local_SegResults = LocalSegmentation_Kmeans_EM_MRF_5classes(imagedata, header, ...
...
newGlobal_SegResult = Combine_Lodal_Global2(global_SegResult, tissuelabels_seg, partsNumber,...
    local_SegResults, LabelPVs_Image);
% ====================================================== %
