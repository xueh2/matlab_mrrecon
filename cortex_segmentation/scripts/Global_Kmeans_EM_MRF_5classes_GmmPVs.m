...
%     clear ICX C sumd D
% else
%     [kmeans_label, header] = LoadAnalyze(KmeansResultFile, header);
% end
...
options(3) = 1.0e-3;
options(5) = 1;
% [mix, options, errlog] = gmmem_MRF_image_uint8_5classes_PVs(mix, x, options);
[mix, options, errlog] = gmmem_MRF_image_uint8_5classes_PVs_WM2CSF(mix, x, options);
