...
Global_dsc_5classes = computeDSC(Global_dsc_result, classlabel, ...
...
savedfilename = fullfile(AssessDir, 'Global_dsc_5classes.mat');
save(savedfilename, 'Global_dsc_5classes', 'tissueVolume');
else
