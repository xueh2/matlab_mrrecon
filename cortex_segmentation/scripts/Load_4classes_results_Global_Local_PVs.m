...
% Global_Local_PVs_dsc_4classes = computeDSC(Global_Local_PVs_dsc_result, classlabel, ...
%             transverseLabel, labeled_trans, ...
%             sagittalLabel, labeled_sag, ...
%             coronaryLabel, labeled_cor, ...
%             header);

% [Global_Local_PVs_dsc_4classes, Global_Local_PVs_FP_4classes, Global_Local_PVs_FN_4classes] = ...
...
[Global_Local_PVs_BSE_4classes, Global_Local_PVs_distPercentages_4classes, dist] = computeBSE_Multiple2D(Global_Local_PVs_dsc_result, classlabel, ...
            transverseLabel, labeled_trans, ...
            sagittalLabel, labeled_sag, ...
            coronaryLabel, labeled_cor, ...
...
savedfilename = fullfile(AssessDir, 'Global_Local_PVs_dsc_4classes.mat');
save(savedfilename, 'Global_Local_PVs_dsc_4classes', 'tissueVolume', 'Global_Local_PVs_FP_4classes',...
    'Global_Local_PVs_FN_4classes', 'Global_Local_PVs_BSE_4classes', 'Global_Local_PVs_distPercentages_4classes');
else
