...
function local_SegResults = LocalSegmentation_Kmeans_EM_MRF_5classes_GmmPVs(imagedata, header, ...
...
%     [mix, options, errlog] = gmmem_MRF_image_uint8_5classes(mix, x, options);
    ...
    options(3) = 1.0e-3;
    options(5) = 1;
    [mix, options, errlog] = gmmem_MRF_image_uint8_5classes_PVs_Local(mix, x, options, parts_mask, global_SegResult);
