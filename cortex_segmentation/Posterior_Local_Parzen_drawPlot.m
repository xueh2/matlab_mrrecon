...
function [post_local, a, plot_a] = Posterior_Local_Parzen_drawPlot(post, mix, x, minimalP, ...
    typeofselection, maxN, Hmin, Hmax)
...
maxX = max(x);
testX = [minX:maxX]';
plot_a = zeros([maxX-minX+1, numofclass], 'single');
