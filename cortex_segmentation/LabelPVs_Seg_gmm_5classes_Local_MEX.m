...
function [LabeledSeg, mix] = LabelPVs_Seg_gmm_5classes_Local_MEX(mix, segResult, ...
...
[LabeledSeg, Priors] = LabelPVs_Seg_gmm_Local_MEX(single(mix.priors), mix.indexes, segResult, neighborNum, lamda,...
    xsize, ysize, zsize, csflabel, wmlabel, cortexlabel, pvlabel, nonbrainlabel, partsmask, globalSeg);
