...
function newGlobal_SegResult = Combine_Lodal_Global2(global_SegResult, tissuelabels_seg,...
...
newGlobal_SegResult(find(LabelPVs_Image==1)) = global_SegResult(find(LabelPVs_Image==1));
return;