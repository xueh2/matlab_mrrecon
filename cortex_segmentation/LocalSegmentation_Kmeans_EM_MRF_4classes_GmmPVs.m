...
function local_SegResults = LocalSegmentation_Kmeans_EM_MRF_4classes_GmmPVs(imagedata, header, ...
...
%     outlierlabel = 3;
    ...
    options(3) = 1e-3;
    options(5) = 1;
    [mix, options, errlog] = gmmem_MRF_image_uint8_4classes_PVs_Local(mix, x, options, parts_mask, global_SegResult);
