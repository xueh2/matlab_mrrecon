...
function local_SegResults = LocalSegmentation_Kmeans_EM_3classes_PVs(imagedata, header, ...
...
%     clear cortexT wmT1 wmT2
    ...
    options(3) = 1e-3;
    options(5) = 1;
    [mix, options, errlog] = gmmem_image_3classes_PVs_Local(mix, x, options, parts_mask, ...
        global_SegResult, 5);
