...
for s=1:NSlc
    ...
    %for b=1:NPhs
    for b=selectedPhase:selectedPhase
...
header_binAveAll_BreathingGating_Phs = header_binAveAll_BreathingGating;
header_binAveAll_BreathingGating_Phs.sizeT = 1;
filename = fullfile(mocoDir, ['binAveAll_BreathingGating_MocoAve_Phs' num2str(selectedPhase)]);
Matlab_SaveAnalyze(single(binAveAll_BreathingGating_MocoAve(:,:,:,selectedPhase)), header_binAveAll_BreathingGating_Phs, [filename '.hdr']);

filename = fullfile(mocoDir, ['binAveAll_BreathingGating_Linear_Phs' num2str(selectedPhase)']);
Matlab_SaveAnalyze(single(binAveAll_BreathingGating_Linear(:,:,:,selectedPhase)), header_binAveAll_BreathingGating_Phs, [filename '.hdr']);
