function [res, RESVEC] = pcgSPIRiT_SymmetricLinearEquation_GPU(y,GOP, nIter, lambda, x0)
%
%
%  res = pcgSPIRiT_SymmetricLinearEquation_GPU(y,GOP, nIter, lambda)
%  
...
[tmpres,FLAG,RELRES,ITER,RESVEC] = pcg(@aprod,yy,lambda,nIter, [],[],x0(idx_nacq),GOP,sx,sy,nCoils,idx_nacq);
...
disp(['pcgSPIRiT symmetric equation : ' num2str(toc(tCGSPIRiT))]);
