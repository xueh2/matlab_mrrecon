function x = cgRegularizedSPIRiTWithLineSearch_2DPlusT_CoilSensitivity_GPU(y, GOP, nIter, x0, S, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegularizedSPIRiTWithLineSearch_2DPlusT_CoilSensitivity_GPU(y, GOP, nIter, x0, params)
%
...
%
% Phi(x) = ||(G-I)*Dc'*yu+(G-I)*D'*y||^2 + lambda*|W*S*F'*(Dc'*yu+D'*y)|_1
%
