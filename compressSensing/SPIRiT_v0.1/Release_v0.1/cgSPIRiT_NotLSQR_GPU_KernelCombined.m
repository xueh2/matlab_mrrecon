function [res, iter] = cgSPIRiT_NotLSQR_GPU_KernelCombined(y, GOP, nIter, lambda, x0)
%
%
%  res = cgSPIRiT_NotLSQR_GPU(y, GOP, nIter, lambda, x0)
%  
...
disp(['cgSPIRiT_NotLSQR_GPU : ' num2str(toc(tCGSPIRiT))]);
