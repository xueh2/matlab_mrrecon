function x = cgRegularizedSPIRiTWithLineSearch_WithoutNullSpace_GPU(y, GOP, nIter, x0, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegularizedSPIRiTWithLineSearch_WithoutNullSpace_GPU(y, GOP, nIter, lambda, x0)
%
...
% calibCostYU = params.GOP*yu;
% calibCostDYU = params.GOP*dyu;
