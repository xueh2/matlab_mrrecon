function [res, RESVEC] = cgSPIRiT_GPU(y,GOP, nIter, lambda, x0)
%
%
...
[tmpres,FLAG,RELRES,ITER,RESVEC] = lsqr(@aprod,yy,lambda,nIter, [],[],x0(idx_nacq),GOP,sx,sy,nCoils,idx_nacq, lambda);
