function x = cgRegSPIRiT_2DPlusT_NoNullSpace_MoCoReg_CoilSensitivity_GPU(y, GOP, nIter, x0, S, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegSPIRiT_2DPlusT_NoNullSpace_MoCoReg_CoilSensitivity_GPU(y, GOP, nIter, lambda, x0)
%
