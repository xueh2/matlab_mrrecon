function x = cgRegularizedSPIRiTWithLineSearch_2DPlusT_MoCoReg_GPU(y, GOP, nIter, x0, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegularizedSPIRiTWithLineSearch_2DPlusT_MoCoReg_GPU(y, GOP, nIter, x0, params)
%
