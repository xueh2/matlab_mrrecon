function [res, RESVEC] = cgSPIRiT3D_SymmetricLinearEquation_GPU(y,GOP, nIter, lambda, x0)
%
%
%  res = cgSPIRiT3D_SymmetricLinearEquation_GPU(y,GOP, nIter, lambda)
%  
...
disp(['cgSPIRiT3D symmetric equation : ' num2str(toc(tCGSPIRiT))]);
