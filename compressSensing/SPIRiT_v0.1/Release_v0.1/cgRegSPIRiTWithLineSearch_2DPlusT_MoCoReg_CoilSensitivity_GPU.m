function x = cgRegSPIRiTWithLineSearch_2DPlusT_MoCoReg_CoilSensitivity_GPU(y, GOP, nIter, x0, S, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegSPIRiTWithLineSearch_2DPlusT_MoCoReg_CoilSensitivity_GPU(y, GOP, nIter, x0, S, params)
%
...
% GOP -	the SPIRiT kernel operator obtained by calibration, an object of SPIRiT2DPlusT
%
...
%         end
    ...
    clear phiPrev phi deltaD thresValue
...
if params.xfmWeight
    grad = grad + params.xfmWeight.*gXFM(x,params);
end

if params.TVWeight
    grad = grad + params.TVWeight.*gTV(x,params);
end

if params.tikWeight
    grad = grad + params.tikWeight.*gTikhonov(x,params);
end
