function x = cgRegularizedSPIRiTWithLineSearch_WithoutNullSpace(y, GOP, nIter, x0, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegularizedSPIRiTWithLineSearch_WithoutNullSpace(y, GOP, nIter, lambda, x0)
%
...
if params.dataWeight
    ...
    DFED(params.idx_acq) = tempY(params.idx_acq) - params.y(params.idx_acq);
    DFED = DFED(:)'*DFED(:);
else
    DFED=0;
end
...
% computes the gradient of the self consistency
