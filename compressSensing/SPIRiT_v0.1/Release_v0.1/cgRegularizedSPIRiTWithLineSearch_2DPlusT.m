function x = cgRegularizedSPIRiTWithLineSearch_2DPlusT(y, GOP, nIter, x0, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegularizedSPIRiTWithLineSearch_2DPlusT(y, GOP, nIter, lambda, x0)
%
