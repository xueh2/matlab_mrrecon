function x = cgRegSPIRiTWithLineSearch_2DPlusT_NoNullSpace_MoCoReg_GPU(y, GOP, nIter, x0, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegSPIRiTWithLineSearch_2DPlusT_NoNullSpace_MoCoReg_GPU(y, GOP, nIter, lambda, x0)
%
