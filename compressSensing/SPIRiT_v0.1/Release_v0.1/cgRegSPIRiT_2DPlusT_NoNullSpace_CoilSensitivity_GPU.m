function x = cgRegSPIRiT_2DPlusT_NoNullSpace_CoilSensitivity_GPU(y, GOP, nIter, x0, S, params, centre, width)
%-----------------------------------------------------------------------
%
% x = cgRegSPIRiT_2DPlusT_NoNullSpace_CoilSensitivity_GPU(y, GOP, nIter, x0, S, params)
%
...
params.y = y; clear y
params.idx_acq = idx_acq; clear idx_acq
params.idx_nacq = idx_nacq; clear idx_nacq
...
if params.xfmWeight  
    Im = params.fftScaling*fftshift(ifft2(ifftshift(gather(tempY))));
...
Im = params.fftScaling*fftshift(ifft2(ifftshift(gather(yu)))); 
Im = sum(params.conjS.*Im, 3);
