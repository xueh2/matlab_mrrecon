...
function patient_studies = PerformGadgetronRecon_SavedIsmrmrd_FindCases(dataDir, scan_type, date_start, date_end)
% patient_studies = PerformGadgetronRecon_SavedIsmrmrd_FindCases(dataDir, scan_type, date_start, date_end)
% patient_studies = PerformGadgetronRecon_SavedIsmrmrd_OneType_FindPatietnStudy('T:\RawData\KAROLINSKA', {'LGE'}, '2016-04-22', '2017-12-11')
% patient_studies = PerformGadgetronRecon_SavedIsmrmrd_OneType_FindPatietnStudy('T:\RawData\BARTS', {'Perfusion'}, '2016-01-01', '2018-01-01')
