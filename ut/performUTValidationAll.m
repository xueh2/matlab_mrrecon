...
setenv('GTPLUS_UT_DIR', 'V:\gtuser\gt_windows_setup\ut')
setenv('GTPLUS_UT_DIR', 'T:\ut');
...
timeUsed = performUTValidation(set_up_UT_cases_GT_UT, UTCollectRef, 0, 'denmark', '9002', 4)
...
performUTValidation(set_up_UT_cases_GT_UT, UTCollectRef, 0, 'localhost', '9002', 3)

performUTValidation(set_up_UT_cases_GT_UT, UTCollectRef, 0, 'denmark', '9002', 4)
