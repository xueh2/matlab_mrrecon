...
UTCases = {
    ...
    'EPI_DTI', 'meas_MID00398_FID105848_DTCMR',  'NX20',   'Generic_Cartesian_Grappa_EPI_AVE.xml',  'grappa_res',  'grappa_ref',   'IsmrmrdParameterMap_Siemens_EPI_NX.xsl'  ; ...   
    ...
    'epi', 'meas_MID00109_FID34637_Thermo_epi',  'VD',   'Generic_Cartesian_Grappa_EPI.xml',  'grappa_res',  'grappa_ref',   'IsmrmrdParameterMap_Siemens_EPI_PF_PreZeros.xsl'  ; ...   
   };
