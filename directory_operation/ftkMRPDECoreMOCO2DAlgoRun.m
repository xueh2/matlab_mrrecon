function ftkMRPDECoreMOCO2DAlgoRun(imageName, MOCOImage, keyFrame, nonRigid_strategy, nonRigid_initial, ... 
    iters, sigma, neighbor, numOfPDMaps, inverseFlag, algo, dxFile, dyFile, BatFileName, exePath)
