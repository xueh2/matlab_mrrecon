...
function RenderVasculatureWithAnatomy2(home, vesselTransformedDir, vesselTransformed_inImage_Dir, anatomyDir)
...
filename = fullfile(home, vesselTransformed_inImage_Dir, 'vesselTransformed_in_t2_image.mat');
vasculature = vasculature_in_leftup_image;
