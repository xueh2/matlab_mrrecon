...
function LevelSetReg_2D_3DRun(target, index, parameterfile, regVolume, dx_file, dy_file)
% rigidly register the image from t2 to tof

command = ['levelset_insights_2D_3D'  '  '  target  '  '  index  '  '  regVolume '  '  '-parin'  ' '  parameterfile '  '  ...
