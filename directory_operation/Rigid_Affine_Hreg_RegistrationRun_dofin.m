...
function Rigid_Affine_Hreg_RegistrationRun_dofin(target_Dir, target_anatomyDir,...
                                    source_Dir, source_anatomyDir,...
                                    result_Dir, Registration_resultsDir,...
                                    rreg_parameterfile, areg_parameterfile, ...
                                    hreg_parameterfiles, dofinfile, numofparameters)
...
% perform the registration
    ...
    % rreg
      RigidRegistrationRun2_dofin(target, source, rregfullname, rreg_parameterfile, dofinfile);
