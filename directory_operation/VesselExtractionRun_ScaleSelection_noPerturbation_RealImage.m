...
function VesselExtractionRun_ScaleSelection_noPerturbation_RealImage(currentDir, tofResampled, extractionResults)
...
[vasculature, coefficient, vasculatureDetected] = RidgeDetection5_ScaleSelection_noPerturbation(data, header, zbs_leftup, zbs_rightdown,...
