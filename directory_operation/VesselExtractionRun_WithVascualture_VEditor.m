...
function [vasculature, handles] = VesselExtractionRun_WithVasculature_VEditor(data, header, presetscales, handles, seeds, scales)
...
%         handles.radiusparameters, doradius, handles.coefficient, seeds, scales, handles.coefficientBlurred, handles.otherparameters.DefaultScale);
    ...
    vasculature = RidgeDetection5_noPerturbation_WithVasculature(data, header, samplestepnew, handles.parameters, ...
        handles.radiusparameters, doradius, handles.coefficient, seeds, scales, handles.coefficientBlurred, handles.otherparameters.DefaultScale, ...
        handles.vasculature);
